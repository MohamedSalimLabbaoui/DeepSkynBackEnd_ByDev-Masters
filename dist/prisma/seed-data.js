        ...
        for (const userData of testUsers) {
            ...
            const user = await prisma.user.create({
                data: {
                    ...
                    churnRiskLevel: Math.random() > 0.7 ? 'low' : Math.random() > 0.4 ? 'medium' : 'high',
            ...
            const skinProfile = await prisma.skinProfile.create({
                data: {
                    ...
                    sensitivities: ['fragrances', 'alcohol'].slice(0, Math.random() > 0.5 ? 1 : 0),
                ...
                if (commenterUser) {
                    await prisma.comment.create({
                        data: {
                            ...
                            postId: post.id,
                            comment: 'This is amazing! Your skin looks so radiant! What products are you using?',
                        },
                    });
                }
            }
            const notifications = [
                ...
                },
                {
                    ...
                    message: 'Your weekly skin check is available. See how your skin has improved!',
                    type: 'success',
                },
            ];
            ...
            await prisma.chatHistory.create({
                data: {
                    ...
                    assistantResponse: 'Based on your skin profile, I recommend a gentle cleanser with salicylic acid, followed by a lightweight moisturizer with niacinamide. Also, use SPF 30+ daily.',
                    context: {
                        skinType: userData.skinType,
                        concerns: userData.concerns,
                    },
